...
public class MTextView extends TextView {
    ...
    private int lineSpacingDP = 10;
    private Map<Integer, List<Integer>> listMap = new HashMap<>();
//	private float lineSpacingMult = 0.5f;
        ...
        for (int i = 0; i < contentList.size(); i++) {
            ...
            for (int j = 0; j < line.line.size(); j++) {
                ...
                if (ob instanceof String) {
                    ...
                    int left = (int) (realDrawedWidth) + 15;
                    int top = (int) height + 15;
                    int right = (int) (realDrawedWidth + width) - 15;
                    int bottom = (int) (height + line.height) + 15;
    ...
    public Map<Integer, List<Integer>> getListMap() {
